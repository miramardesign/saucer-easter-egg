...
(function ($, Math, Date, window) {
    ...
    $.fn.flyingSaucerAttack = function (opts) {
        ...
        let saucerEasterEgg = {
                        ...
                        function () {
                            saucerEasterEgg.flyAbove($target, $saucer)
                                    .then(function () {
                                        ...
                                        delay(500)
                                                .then(
                                                        //needs a callback since inside jQuery animation
                                                                function () {
                                                                    saucerEasterEgg.flyAway($saucer, $target).then(function(){
             ...
             * @param {function} callback function ater animation
             * @returns {undefined}
             */
            flyAbove: function ($target, $saucer, callback) {
             ...
             * @returns {undefined}
             */
            flyAway: function ($saucer, $target, callback) {
